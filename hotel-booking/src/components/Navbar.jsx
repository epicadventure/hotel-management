  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-8">
        ...
        {user && (
          <button
            className={`border  px-4 py-1 text-sm font-light rounded-full cursor-pointer uppercase hover:bg-gray-200 ${isScrolled ? "text-black" : "text-white uppercase hover:text-black"
              } transition-all`}
